...
from src.API.Controllers.RelationshipFoodVitamin.relationshipfoodvitamincontroller import RelationshipFoodVitaminController
...
app.include_router(RelationshipFoodVitaminController.router)
